...
You are provided with the following information $$ \hat{\beta_0} = b_0 = 58.816$$ $$ \hat{\beta_1} = b_1 = -1.867$$ $$ s(b_1) = 0.346$$ $$ MSE = 4.417$$ $$\hat{y}= 58.816 − 1.867x$$ 
...
**R/**
$$Systolic BP = \beta_0 + \beta_1 * Age + \beta_2 * Weight + \epsilon_i$$
